...
public interface MapStructRestDtoMapper {
    ...
    SubmissionDto map(BatchSetSubmissionsForStudentAndCourseRestDto.SubmissionSetForStudentAndCourseRestDto dto);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "lastModifiedAt", ignore = true)
    @Mapping(target = "mainScore", ignore = true)
    SubmissionDto map(BatchSetSubmissionsForCourseRestDto.SubmissionSetForCourseRestDto dto);
